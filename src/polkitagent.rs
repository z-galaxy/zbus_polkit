...
pub use agent_session::PolkitAgentSession;
mod interface;
pub mod unixsession;
use interface::*;
...
use crate::{identify::Identity, policykit1::AuthorityProxy};

use unixsession::UnixSession;
    ...
    State: 'static + Send + Sync,
{
    ...
    ) -> Result<zbus::Connection, crate::error::Error> {
